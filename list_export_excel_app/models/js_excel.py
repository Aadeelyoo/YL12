			...
			for value in values:
				for lines in fields_row:
					...
					if lines:
						...
						elif val == 'many2many' and isinstance(value[lines], list):
								many2many_values = str(value[lines])
								worksheet.write(row_2, col_0, many2many_values, xlwt.easyxf("font: name Liberation Sans"))
