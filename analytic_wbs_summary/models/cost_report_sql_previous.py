...
class AnalyticWbsSummary(models.Model):
    _name = 'analytic_wbs_cost_report_previous'
    _auto = False
    ...
    def init(self):
        ...
        query = """
        CREATE OR REPLACE VIEW analytic_wbs_cost_report_previous AS 
        (
        ...
        FROM 
            ...
            SELECT
                ...
                analytic_wbs_record_line.data_col AS data_col, 
                analytic_wbs_record_line.data_col_group AS data_col_group, 
                analytic_wbs_record_line.amount AS amount
            FROM
                    ...
                    FROM
                        ...
                        (
                            SELECT
                                ...
                                "max" ( analytic_wbs_record.report_end_period ) AS lastreport
                            FROM
                                analytic_wbs_record
                            WHERE
                        ...
                        ON 
                            analytic_wbs_record.project_id = rec.project_id AND
                            analytic_wbs_record.report_end_period = rec.lastreport
                    WHERE
            ...
            WHERE
                analytic_wbs_record_line.amount <> 0
            ) AS summary
        )
        """
