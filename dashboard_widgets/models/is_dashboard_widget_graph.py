...
class DashboardWidgetGraph(models.AbstractModel):
    ...
    display_mode = fields.Selection(string="Display Type", selection_add=[
        ('graph', 'Chart / Graph'),
    ], required=True)

    graph_type = fields.Selection(string="Graph Type", selection=[
        ('line', 'Line'),
        ('bar', 'Bar'),
        ('pie', 'Pie'),
        ('radar', 'Radar'),
    ...
    chart_1_config_color = fields.Char("Chart Color (1)", default='#4286f4')
    ...
    chart_2_config_color = fields.Char("Chart Color (2)", default='#ef3248')
