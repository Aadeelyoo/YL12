...
class account_analytic_wbs_sow_line(models.Model):
    _name = 'account.analytic_wbs.sow_line'
    ...
    line_transaction_id = fields.Many2one('account.analytic_wbs.sow_transaction', 'Sow Transaction', required=True, ondelete='cascade')
    sow_transaction_state = fields.Selection(related="line_transaction_id.state", string="Transaction State", readonly=True, store=True)
    ...
    tag_ids = fields.Many2many('account.analytic_wbs.tag', 'account_analytic_wbs_sow_line_tag_rel', 'line_id', 'tag_id', string='Tags', copy=True)
    ...
    def unlink(self):
        ...
        return super(account_analytic_wbs_sow_line, self).unlink()


class account_analytic_wbs_sow_transaction(models.Model):
    _name = 'account.analytic_wbs.sow_transaction'
    ...
    name = fields.Char('Sow Transaction No', required=True, default=_default_name, track_visibility='onchange')
    ...
    transaction_type_id = fields.Many2one('account.analytic_wbs.sow_transaction_type', 'Transaction Type', required=False, ondelete='restrict')
    transaction_detail_ids = fields.One2many('account.analytic_wbs.sow_line', 'line_transaction_id', string='Transaction Detail')
    ...
    def unlink(self):
        ...
        return super(account_analytic_wbs_sow_transaction, self).unlink()
    ...
    def _track_subtype(self, init_values):
        ...
        return super(account_analytic_wbs_sow_transaction, self)._track_subtype(init_values)
...
class account_analytic_wbs_sow_transaction_type(models.Model):
    _name = 'account.analytic_wbs.sow_transaction_type'
